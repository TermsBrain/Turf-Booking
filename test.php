...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
                    ...
                    <ul class="navbar-nav float-start me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="createSeller.php">Seller</a></li>
                                <li><a class="dropdown-item" href="createShop.php">Shop</a></li>
                                <li><a class="dropdown-item" href="createSupplier.php">Supplier</a></li>
                                <li>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="pt-4">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu"> Create </span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="createSeller.php" class="sidebar-link"><i class="mdi mdi-account-plus"></i><span class="hide-menu"> Seller </span></a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="createShop.php" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class="hide-menu"> Shop </span></a>
                                </li>

                                <li class="sidebar-item">
                                    <a href="createSupplier.php" class="sidebar-link"><i class="mdi mdi-ambulance"></i><span class="hide-menu"> Supplier </span></a>
                                </li>
                            </ul>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-border-inside"></i><span class="hide-menu"> Tables </span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="allSellers.php" class="sidebar-link"><i class="mdi mdi-table-large"></i><span class="hide-menu"> All Sellers </span></a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="allShops.php" class="sidebar-link"><i class="mdi mdi-table-large"></i><span class="hide-menu"> All Shops </span></a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="allSuppliers.php" class="sidebar-link"><i class="mdi mdi-table-large"></i><span class="hide-menu"> All Suppliers </span></a>
                                </li>
                            </ul>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="shopManagement.php" aria-expanded="false"><i class="mdi as fa-th"></i><span class="hide-menu">Manage Shops</span></a>
                        </li>
                        <li class="sidebar-item">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <footer class="footer text-center">
                    All Rights Reserved by Terms Brain. Designed and Developed by
                    <a href="https://www.termsbrain.com">Terms Brain</a>.
                </footer>
                <!-- ============================================================== -->
                <!-- End footer -->
                <!-- ============================================================== -->
        ...
        <?php
        if (isset($_SESSION['scs-msg-create'])) {
            $success_not = "<script>
                        toastr.success('Seller " . $_SESSION['scs-msg-create'] . " has successfully created!!', 'Successfully Created');
                    </script>";
            echo $success_not;
            unset($_SESSION['scs-msg-create']);
        }
        if (isset($_SESSION['scs-msg-edit'])) {
            $success_not = "<script>
                      toastr.success('Seller " . $_SESSION['scs-msg-edit'] . " has successfully edited!!', 'Successfully Created');
                  </script>";
            echo $success_not;
            unset($_SESSION['scs-msg-edit']);
        }
        if (isset($_SESSION['scs-msg-delete'])) {
            $success_not = "<script>
                      toastr.error('Seller " . $_SESSION['scs-msg-delete'] . " has successfully deleted!!', 'Successfully deleted');
                  </script>";
            echo $success_not;
            unset($_SESSION['scs-msg-delete']);
        }
        ?>
</body>
